 ...
 */
?>
<header id="navbar" role="banner" class="<?php print $navbar_classes; ?> container-fullwidth">
...
<div class="banner banner__wrapper banner__custom-image header-banner <?php print $classes; ?>" role="banner" style="<?php print $background; ?>;">
  ...
  <div class="banner__wrapper__inner container">
    <div class="banner__content row">
      <div class="banner__title col-md-12">
        <h1 class="page__title"><?php print render($content); ?></h1>
      </div>
    </div>
  </div>
