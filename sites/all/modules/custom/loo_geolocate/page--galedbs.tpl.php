...
/**
 * @file
 * Modified template for display of Gale databases iframe.
 *
 * Available variables:
 *
...
if (!empty($state) && ('OR' == $state || 'Oregon' == $state)) {
  ...
  $proxy_url = variable_get('ezproxy_url');
  $proxy_user = variable_get('ezproxy_user');
  $proxy_secret = variable_get('ezproxy_secret');
  $ezproxy = new EZproxyTicket($proxy_url, $proxy_secret, $proxy_user);
  ...
  drupal_set_message('This service is available only to individuals currently in the state of Oregon.', 'warning');
  drupal_goto('/home');
}
?>
<div id="wrapper">
  <div class="inwrap">
    <div id="header-top">
      <div class="logo">
        ...
        <?php if (theme_get_setting('social_links', 'loo')): ?>
          <div class="social-icons">
            <ul>
              <li><a href="<?php print $front_page; ?>rss.xml"><img src="<?php print base_path() . check_plain(drupal_get_path('theme', 'loo')) . '/images/rss.png'; ?>" alt="RSS Feed"/></a></li>
              <li><a href="http://www.facebook.com/<?php echo check_plain(theme_get_setting('facebook_username', 'loo')); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'loo') . '/images/facebook.png'; ?>" alt="Facebook"/></a></li>
              <li><a href="http://www.twitter.com/<?php echo check_plain(theme_get_setting('twitter_username', 'loo')); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'loo') . '/images/twitter.png'; ?>" alt="Twitter"/></a></li>
            </ul>
          </div>
        <?php endif; ?>
      </div>
    ...
    <div id="content-container">
      ...
      <?php if ($is_front): ?>
        <?php if (theme_get_setting('slideshow_display', 'loo')): ?>
          <div id="slideshow">
            <div id="slides">
              <div class="slides_container">
                <img src="<?php print base_path() . drupal_get_path('theme', 'loo') . '/images/slide-image-1.jpg'; ?>"/>
                <img src="<?php print base_path() . drupal_get_path('theme', 'loo') . '/images/slide-image-2.jpg'; ?>"/>
                <img src="<?php print base_path() . drupal_get_path('theme', 'loo') . '/images/slide-image-3.jpg'; ?>"/>
              </div>
      ...
      <div id="page-container">
        ...
        <div id="dbs-content">
          <?php if (theme_get_setting('breadcrumbs', 'loo')): ?><div class="breadcrumb"><?php if ($breadcrumb): print $breadcrumb; endif;?></div><?php endif; ?>
        ...
        <?php if (theme_get_setting('footer_copyright', 'loo') || theme_get_setting('footer_credits', 'loo')): ?>
          <div id="footer">
            <?php if (theme_get_setting('footer_copyright', 'loo')): ?>
              <div class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?>.</div>
            <?php endif; ?>
            <?php if (theme_get_setting('footer_credits', 'loo')): ?>
